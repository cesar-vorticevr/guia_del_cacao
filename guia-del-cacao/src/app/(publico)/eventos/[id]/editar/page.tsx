  ...
  return (
    <div className="mx-auto grid max-w-xl gap-6">
      ...
      <FormularioEditarEvento
        ...
        fotos={evento.imagenes}
        urlDeFoto={Object.fromEntries(
          evento.imagenes
            .map((ruta) => [ruta, urlImagen(ruta)])
        ...
        <details>
          ...
          <div className="mt-3 grid gap-4 rounded-3xl border-2 border-guayaba/40 bg-guayaba/10 p-5">
            <p className="text-cacao">
              ...
              el evento se cayó,{" "}
              <strong className="text-selva-2">es mejor cancelarlo</strong>: así
              quien apartó la fecha se entera en vez de encontrarse un hueco.
            </p>
