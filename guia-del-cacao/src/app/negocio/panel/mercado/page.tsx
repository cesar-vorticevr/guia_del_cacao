...
export const metadata: Metadata = { title: "Mercado · Guía del Cacao" };

/**
 * El mercado del negocio: lo que ofrece a cambio de mazorcas.
 *
...
export default async function Mercado() {
  ...
  return (
    <div className="grid gap-6">
      <div>
        <h1 className="font-display text-3xl">Mercado</h1>
